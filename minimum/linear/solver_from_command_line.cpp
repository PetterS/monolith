...
std::vector<std::string> allowed = {"ip", "glpk", "minisat", "scs", "primal-dual", "constraint"};
...
DEFINE_bool(solver_verbose, false, "Whether subsolvers (like Minisat) should be verbose.");
