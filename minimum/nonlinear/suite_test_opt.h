...
struct GoldsteinPricePolynomial {
	...
	R operator()(const R* const x) const {
		...
		R b = 19.0 - 14.0 * x[0] + 3.0 * x[0] * x[0] - 14.0 * x[1] + 6.0 * x[0] * x[1]
		      + 3.0 * x[1] * x[1];

		R c = 2.0 * x[0] - 3.0 * x[1];

		R d = 18.0 - 32.0 * x[0] + 12.0 * x[0] * x[0] + 48.0 * x[1] - 36.0 * x[0] * x[1]
		      + 27.0 * x[1] * x[1];
...
struct Bohachevsky1 {
	...
	template <typename R>
	R operator()(const R* const x) const {
		return x[0] * x[0] - 0.3 * cos(3.0 * 3.141592 * x[0]) + 2.0 * x[1] * x[1]
		       - 0.4 * cos(4.0 * 3.141592 * x[1]) + 0.7;
	}
};
...
struct Bohachevsky2 {
	...
	R operator()(const R* const x) const {
		return x[0] * x[0] + 2.0 * x[1] * x[1]
		       - 0.3 * cos(3.0 * 3.141592 * x[0]) * cos(4.0 * 3.141592 * x[1]) + 0.3;
	}
};
...
struct Bohachevsky3 {
	template <typename R>
	R operator()(const R* const x) const {
		return x[0] * x[0] + 2.0 * x[1] * x[1] - 0.3 * cos(3.0 * 3.141592 * x[0])
...
struct Colville {
	...
	R operator()(const R* const x) const {
		return 100.0 * (x[1] - x[0] * x[0]) * (x[1] - x[0] * x[0]) + (1.0 - x[0]) * (1.0 - x[0])
		       + 90.0 * (x[3] - x[2] * x[2]) * (x[3] - x[2] * x[2]) + (1.0 - x[2]) * (1.0 - x[2])
		       + 10.1 * ((x[1] - 1.0) * (x[1] - 1.0) + (x[3] - 1.0) * (x[3] - 1.0))
...
struct Powell3D {
	...
	R operator()(R* x) const {
		...
		return 3.0 - 1.0 / (1.0 + (x[0] - x[1]) * (x[0] - x[1]))
		       - sin(0.5 * 3.141592653589793 * x[1] * x[2]) - term;
	}
};
