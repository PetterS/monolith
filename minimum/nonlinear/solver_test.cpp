...
#include <minimum/nonlinear/google_test_compatibility.h>
#include <catch.hpp>
...
TEST(Solver, L_GBFS_exact) {
	...
	iters.push_back(1);
	fvals.push_back(2.19820e+01);
	iters.push_back(2);
	fvals.push_back(4.96361e+00);
	iters.push_back(3);
	fvals.push_back(4.16118e+00);
	iters.push_back(4);
	fvals.push_back(4.09480e+00);
	iters.push_back(5);
	fvals.push_back(4.09165e+00);
	iters.push_back(6);
	fvals.push_back(3.87014e+00);
	iters.push_back(7);
	fvals.push_back(3.72822e+00);
	iters.push_back(8);
	fvals.push_back(3.45143e+00);
	iters.push_back(9);
	fvals.push_back(2.93307e+00);
	iters.push_back(10);
	fvals.push_back(2.45070e+00);
	iters.push_back(11);
	fvals.push_back(2.28498e+00);
	iters.push_back(12);
	fvals.push_back(1.96226e+00);
	iters.push_back(13);
	fvals.push_back(1.52784e+00);
	iters.push_back(14);
	fvals.push_back(1.33065e+00);
	iters.push_back(15);
	fvals.push_back(1.17817e+00);
	iters.push_back(16);
	fvals.push_back(9.82334e-01);
	iters.push_back(17);
	fvals.push_back(7.82560e-01);
	iters.push_back(18);
	fvals.push_back(6.26596e-01);
	iters.push_back(19);
	fvals.push_back(5.56740e-01);
	iters.push_back(20);
	fvals.push_back(4.76314e-01);
	iters.push_back(21);
	fvals.push_back(3.21285e-01);
	iters.push_back(22);
	fvals.push_back(2.91320e-01);
	iters.push_back(23);
	fvals.push_back(2.24196e-01);
	iters.push_back(24);
	fvals.push_back(1.72268e-01);
	iters.push_back(25);
	fvals.push_back(1.29991e-01);
	iters.push_back(26);
	fvals.push_back(9.11752e-02);
	iters.push_back(27);
	fvals.push_back(5.74927e-02);
	iters.push_back(28);
	fvals.push_back(3.14319e-02);
	iters.push_back(29);
	fvals.push_back(1.49973e-02);
	iters.push_back(30);
	fvals.push_back(9.20225e-03);
	iters.push_back(31);
	fvals.push_back(2.61646e-03);
	iters.push_back(32);
	fvals.push_back(6.34734e-04);
	iters.push_back(33);
	fvals.push_back(9.00566e-05);
	iters.push_back(34);
	fvals.push_back(7.38860e-06);
	iters.push_back(35);
	fvals.push_back(2.55965e-07);
	iters.push_back(36);
	fvals.push_back(3.40434e-10);
...
TEST(Solver, Newton_exact) {
	...
	std::vector<double> fvals;
	iters.push_back(1);
	fvals.push_back(4.73188e+000);
	iters.push_back(2);
	fvals.push_back(4.08740e+000);
	iters.push_back(3);
	fvals.push_back(3.22867e+000);
	iters.push_back(4);
	fvals.push_back(3.21390e+000);
	iters.push_back(5);
	fvals.push_back(1.94259e+000);
	iters.push_back(6);
	fvals.push_back(1.60019e+000);
	iters.push_back(7);
	fvals.push_back(1.17839e+000);
	iters.push_back(8);
	fvals.push_back(9.22412e-001);
	iters.push_back(9);
	fvals.push_back(5.97489e-001);
	iters.push_back(10);
	fvals.push_back(4.52625e-001);
	iters.push_back(11);
	fvals.push_back(2.80762e-001);
	iters.push_back(12);
	fvals.push_back(2.11393e-001);
	iters.push_back(13);
	fvals.push_back(8.90195e-002);
	iters.push_back(14);
	fvals.push_back(5.15354e-002);
	iters.push_back(15);
	fvals.push_back(1.99928e-002);
	iters.push_back(16);
	fvals.push_back(7.16924e-003);
	iters.push_back(17);
	fvals.push_back(1.06961e-003);
	iters.push_back(18);
	fvals.push_back(7.77685e-005);
	iters.push_back(19);
	fvals.push_back(2.82467e-007);
	iters.push_back(20);
	fvals.push_back(8.51707e-012);
...
TEST(Solver, Newton_exact_Wolfe) {
	...
	std::vector<double> fvals = {4.73188e+00, 4.08740e+00, 3.22867e+00, 2.76783e+00, 2.17872e+00,
	                             1.66968e+00, 1.26823e+00, 9.13472e-01, 6.86341e-01, 4.35423e-01,
	                             3.19604e-01, 1.92120e-01, 1.13097e-01, 5.32981e-02, 2.88735e-02,
	                             6.63610e-03, 2.23143e-03, 4.18107e-05, 1.70026e-07, 2.75421e-13};
...
TEST(Solver, LBFGS_exact_Wolfe_far) {
	...
	std::vector<double> fvals = {1.46190e+14,
	                             3.41218e+13,
	                             1.24973e+13,
	                             3.86189e+12,
	                             1.27251e+12,
...
TEST_CASE("LBFGS_exact_Wolfe_interpolation") {
	...
	std::vector<double> fvals = {
	    1.69372e+10, 3.63800e+09, 1.35617e+09, 4.07136e+08, 1.30647e+08, 3.95499e+07, 1.15617e+07,
	    3.08730e+06, 7.06478e+05, 1.20698e+05, 1.19546e+04, 5.30431e+02, 1.24938e+02, 1.22820e+02,
	    1.22820e+02, 1.22819e+02, 1.22818e+02, 1.22816e+02, 1.22808e+02, 1.22790e+02, 1.22741e+02,
	    1.22610e+02, 1.22244e+02, 1.05808e+02, 1.05502e+02, 9.98985e+01, 9.52870e+01, 8.98113e+01,
	    8.35851e+01, 8.27050e+01, 7.90132e+01, 7.38046e+01, 7.05325e+01, 6.80851e+01, 6.20812e+01};
...
class ExpTransform {
   public:
	...
	int x_dimension() const { return dimension; }

	int t_dimension() const { return dimension; }
};
...
TEST(Solver, SimpleConstraints) {
	...
	function.add_term(std::make_shared<AutoDiffTerm<Quadratic2, 2>>(), x);

	double t[2] = {0, 0};
	Function function_changed;
	function_changed.add_variable(t, 2);
	function_changed.add_term(std::make_shared<AutoDiffTerm<Quadratic2Changed, 2>>(), t);
...
TEST(NewtonSolver, constant_variables) { test_constant_variables<NewtonSolver>(); }

TEST(LBFGSSolver, constant_variables) { test_constant_variables<LBFGSSolver>(); }
...
TEST(NewtonSolver, callback_function) { test_callback_function<NewtonSolver>(); }

TEST(LBFGSSolver, callback_function) { test_callback_function<LBFGSSolver>(); }

TEST(NelderMeadSolver, callback_function) { test_callback_function<NelderMeadSolver>(); }
...
TEST(NewtonSolver, empty_function_crash_bug) { test_empty_function_crash_bug<NewtonSolver>(); }

TEST(LBFGSSolver, empty_function_crash_bug) { test_empty_function_crash_bug<LBFGSSolver>(); }

TEST(NelderMeadSolver, empty_function_crash_bug) {
	test_empty_function_crash_bug<NelderMeadSolver>();
}

TEST(PatternSolver, empty_function_crash_bug) { test_empty_function_crash_bug<PatternSolver>(); }
