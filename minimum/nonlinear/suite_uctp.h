...
TEST(Solver, ExpAndSquares2) { test_exp_and_squares<2>(); }

TEST(Solver, ExpAndSquares10) { test_exp_and_squares<10>(); }

TEST(Solver, ExpAndSquares50) { test_exp_and_squares<20>(1e-5); }
