#  NLP written by GAMS Convert at 06/20/02 12:04:37
#  
#  Equation counts
#     Total       E       G       L       N       X
#        77      77       0       0       0       0
...
e8: x12*x7 - (x37*x57 + x41*x62 + x45*x67 + x49*x72 + x53*x77) - 0.58*x2 = 0;
...
e12: x16*x8 - (x37*x58 + x41*x63 + x45*x68 + x49*x73 + x53*x78) - 0.58*x3 = 0;
...
e16: x20*x9 - (x37*x59 + x41*x64 + x45*x69 + x49*x74 + x53*x79) - 0.58*x4 = 0;
...
e20: x24*x10 - (x37*x60 + x41*x65 + x45*x70 + x49*x75 + x53*x80) - 0.58*x5 = 0;
...
e24: x28*x11 - (x37*x61 + x41*x66 + x45*x71 + x49*x76 + x53*x81) - 0.58*x6 = 0;
...
e33: x37*x32 - (x12*x7 + x92*(-x97 - x99)) = 0;
...
e37: x41*x33 - (x16*x8 + x93*(-x100 - x102)) = 0;
...
e41: x45*x34 - (x20*x9 + x94*(-x103 - x105)) = 0;
...
e45: x49*x35 - (x24*x10 + x95*(-x106 - x108)) = 0;
...
e49: x53*x36 - (x28*x11 + x96*(-x109 - x111)) = 0;
